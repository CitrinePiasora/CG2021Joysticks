...
import { Engine, Scene, Vector3, VirtualJoysticksCamera , SceneLoader, Camera, Light, Animation } from "@babylonjs/core";
...
class App {
    ...
    private _createScene(canvas: HTMLCanvasElement, engine: Engine): Scene {
        ...
        const camera = new VirtualJoysticksCamera("vrCam", new Vector3(0, 1, 0), scene);
